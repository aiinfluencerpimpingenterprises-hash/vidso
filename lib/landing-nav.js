...
import { GENERATE_HREF, PRICING_HREF, TOOL_MENU_ITEMS } from './public-tools.js'
import {
  MODELS_HREF,
  MODELS_PROMO,
  MODEL_GROUPS,
...
export const TOOLS_CTA = { label: 'Start Creating', href: GENERATE_HREF }
...
export const NAV_OMITTED = [
  ...
  { menu: 'Resources', label: 'Tutorials', reason: 'Footer still lists /tutorials, but that page is not built.' },
