...
export const FEATURE_ROWS = [
  ...
  {
    type: 'value',
    label: 'Faceless Studio credits',
    hidden: true,
    plus: formatQuotaLabel(ENTITLEMENTS.plus.studio_credits_per_month),
    pro: formatQuotaLabel(ENTITLEMENTS.pro.studio_credits_per_month),
    studio: formatQuotaLabel(ENTITLEMENTS.studio.studio_credits_per_month),
  },
