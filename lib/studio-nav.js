...
export const HOME_PROMPT_MODES = [
  ...
  { id: 'voiceover', label: 'Voiceover', panel: 'voiceover', format: null },
]

export const HOME_PROMPT_IDEAS = HERO_PROMPTS.slice()

export const ASK_BEHAVIORS = [
  { id: 'ask', label: 'Ask first', hint: 'Review the prompt in the tool before generating.' },
  { id: 'run', label: 'Just make it', hint: 'Same navigation. The generator still confirms before it runs.' },
]

export const ATTACH_MENU = [
  { id: 'upload', label: 'Upload media', hint: 'Uses the existing My Files uploader.' },
  { id: 'url', label: 'Import from URL', hint: 'Opens Video Downloader with the URL field.' },
]
...
export const HOME_CHIPS_MORE = HERO_PROMPTS.slice(1).map((fill, i) => ({
  id: 'more-' + (i + 1),
  label: fill,
  icon: 'videogen',
  fill,
...
export const START_FORMATS = [
  { id: 'long-form', label: 'Long-form', slug: 'long-form', panel: 'videogen', format: 'long', badge: '', chip: '16:9', ratio: '16:9' },
  { id: 'short', label: 'Short', slug: 'short', panel: 'videogen', format: 'shorts', badge: '', chip: '9:16', ratio: '9:16' },
  { id: 'thumbnail', label: 'Thumbnail', slug: 'thumbnail', panel: 'imagegen', format: null, badge: 'New', chip: 'Still', ratio: '16:9' },
  { id: 'clip', label: 'Clip', slug: 'clip', panel: 'clipper', format: null, badge: '', chip: '9:16', ratio: '9:16' },
  { id: 'ranking', label: 'Ranking video', slug: 'ranking', panel: 'ranking', format: null, badge: '', chip: '9:16', ratio: '9:16' },
  { id: 'ugc', label: 'UGC', slug: 'ugc', panel: 'videogen', format: 'shorts', badge: '', chip: '9:16', ratio: '9:16' },
  { id: 'explainer', label: 'Explainer', slug: 'explainer', panel: 'videogen', format: 'long', badge: '', chip: '16:9', ratio: '16:9' },
  { id: 'listicle', label: 'Listicle', slug: 'listicle', panel: 'videogen', format: 'long', badge: '', chip: '16:9', ratio: '16:9' },
]
...
export const WHATS_NEW = [
  ...
  },
  {
    id: 'mcp',
    title: 'Vidso MCP',
    blurb: 'Run Vidso from Claude, ChatGPT, Cursor, or Kimi.',
    tag: 'New',
    chip: 'MCP',
    href: '/mcp',
    panel: '',
  ...
  },
  {
    ...
    blurb: 'See the models Vidso actually uses.',
    tag: '',
    chip: 'Catalog',
    href: '/models',
    panel: '',
  ...
  },
  {
    ...
    blurb: 'Turn a topic into a narrated short or long-form video.',
    tag: '',
    chip: 'Long-form',
    href: '/video-generation',
    panel: 'videogen',
...
export const PLACEHOLDER_FILES = {
  ...
  inspire: INSPIRE_CATEGORIES.flatMap((c) => [1, 2, 3, 4, 5, 6].map((n) => `home-inspire-${c.id}-0${n}.jpg`)),
