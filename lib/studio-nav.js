...
export const HOME_PROMPT_MODES = [
  { id: 'long', label: 'Long-form', panel: 'videogen', format: 'long', hint: 'Narrated video with B-roll and captions' },
  { id: 'shorts', label: 'Shorts', panel: 'videogen', format: 'shorts', hint: '30 to 60 second vertical cut' },
  { id: 'thumbnail', label: 'Thumbnail', panel: 'imagegen', format: null, hint: 'Image for a video title' },
  { id: 'voiceover', label: 'Voiceover', panel: 'voiceover', format: null, hint: 'Narration from a script' },
]

export const HOME_PROMPT_IDEAS = HERO_PROMPTS.slice()

export const ASK_BEHAVIORS = [
  { id: 'ask', label: 'Ask first', hint: 'Vidso confirms the plan before generating' },
  { id: 'run', label: 'Just make it', hint: 'Generate immediately' },
]
...
export const HELP_MENU = [
  { id: 'whats-new', label: "What's new", href: '', go: 'dashboard', extra: 'news' },
  { id: 'help-center', label: 'Help center', href: '/home#faq' },
  { id: 'feedback', label: 'Feedback', href: 'mailto:support@vidso.pro?subject=Vidso%20feedback' },
  { id: 'email', label: 'Email us', href: 'mailto:support@vidso.pro' },
  { id: 'terms', label: 'Terms and policies', href: '/terms' },
]
