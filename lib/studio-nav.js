...
export const START_FORMATS = [
  { id: 'long-form', label: 'Long-form', slug: 'long-form', panel: 'videogen', format: 'long', badge: '' },
  { id: 'short', label: 'Short', slug: 'short', panel: 'videogen', format: 'shorts', badge: '' },
  { id: 'thumbnail', label: 'Thumbnail', slug: 'thumbnail', panel: 'imagegen', format: null, badge: 'New' },
  { id: 'clip', label: 'Clip', slug: 'clip', panel: 'clipper', format: null, badge: '' },
  { id: 'ranking', label: 'Ranking video', slug: 'ranking', panel: 'ranking', format: null, badge: '' },
  { id: 'ugc', label: 'UGC', slug: 'ugc', panel: 'videogen', format: 'shorts', badge: '' },
  { id: 'explainer', label: 'Explainer', slug: 'explainer', panel: 'videogen', format: 'long', badge: '' },
  { id: 'listicle', label: 'Listicle', slug: 'listicle', panel: 'videogen', format: 'long', badge: '' },
]
