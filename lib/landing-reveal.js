...
export function checkHeadingCenters(root = document) {
  ...
  const secs = [...root.querySelectorAll('.showcase, .shorts, .workflow-tiles, .top-models, .models-hero, .models-index, .mcp-hero, .mcp-excerpt, .mcp-setup, .mcp-bring, .mcp-ask, .mcp-clients, .formats-float, .why-stack, .faq, .final, .format-econ, .compare, .comp-compare, .pricing, .results')]
...
export function mountLandingReveals() {
  ...
  const scopes = [...page.querySelectorAll('.showcase, .shorts, .workflow-tiles, .top-models, .models-hero, .models-index, .lp-feat, .mcp-hero, .mcp-excerpt, .mcp-setup, .mcp-bring, .mcp-ask, .mcp-clients, .demo-hero, .formats-float, .why-stack, .faq, .final, .format-econ, .compare, .comp-compare, .pricing, .results')]
  scopes.forEach((sec) => {
    ...
    sec.querySelectorAll('.s-head .lp-sub, .shorts-head .lp-sub, .mcp-sub, .final-box p, .wf-punch, .formats-float .lp-sub, .mcp-excerpt .lp-sub, .mcp-bring .lp-sub, .mcp-ask .lp-sub, .top-models-copy .lp-sub, .models-hero .lp-sub').forEach((p) => p.classList.add('rv-sub'))
    sec.querySelectorAll('.feat-media, .coverflow, .shorts-stage, .results-shot, .tab-still, .mcp-panel, .mcp-keys, .mcp-blank, .mcp-clients-card, .demo-frame, .comp-table-wrap, .final-box, .top-models-orbit, .models-grid').forEach((m) => m.classList.add('rv-media'))
    const items = sec.querySelectorAll('.wf-tile, .fmt-float, .mcp-step, .cmp, .plan, .faq-grid details')
    items.forEach((el, i) => {
