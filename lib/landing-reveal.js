...
export function mountLandingReveals() {
  ...
  scopes.forEach((sec) => {
    ...
    sec.querySelectorAll('.s-head .lp-sub, .shorts-head .lp-sub, .mcp-sub, .final-box p, .wf-punch, .formats-float .lp-sub, .mcp-excerpt .lp-sub, .mcp-ask .lp-sub, .mcp-models .lp-sub, .top-models-copy .lp-sub, .models-hero .lp-sub, .yt-compact .lp-sub, .ugc-row .lp-sub, .studio-tools .lp-sub').forEach((p) => p.classList.add('rv-sub'))
