...
export function mountLandingReveals() {
  ...
  scopes.forEach((sec) => {
    ...
    sec.querySelectorAll('.feat-media, .coverflow, .shorts-stage, .results-shot, .tab-still, .mcp-keys, .mcp-blank, .comp-table-wrap, .final-box, .top-models-orbit, .models-grid, .studio-panel, .ugc-row-track, .yt-stats').forEach((m) => m.classList.add('rv-media'))
