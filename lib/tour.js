  ...
  },
  {
    ...
    steps: [
      step({
        id: 'tools-map',
        eyebrow: 'Tools',
        title: 'The Tools gallery',
        body: 'Open Tools in the top bar for Clipping, Ranking, captions, and the rest. The gallery still lists every tool in one place.',
      ...
      step({
        ...
        eyebrow: 'Tools',
        title: 'Generate',
        body: 'Thumbnail Generator, Video Generation, Clipping, and Ranking start new work from a prompt or a link.',
...
/** Video Generation first, then the rest of the app. */
const TOUR_PLAY_IDS = [
