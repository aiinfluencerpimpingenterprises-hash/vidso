...
export const TOURS = [
  {
    ...
    steps: [
      ...
      step({
        ...
        body: 'Every other tool lives in this navigation: thumbnails, clipping, ranking, captions, voiceover, and the editor. Open Getting started from your avatar menu anytime to replay a tour.',
        target: '#app-topnav',
        route: 'videogen',
        needsNav: true,
        fvStage: 'setup',
