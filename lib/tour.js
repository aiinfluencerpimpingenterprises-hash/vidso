...
export const TOURS = [
  {
    ...
    steps: [
      step({
        ...
        body: 'This walkthrough covers Video Generation: topic, length, voice, script, media, and export. You can skip at any time.',
        target: null,
        placement: 'center',
        route: 'videogen',
        fvStage: 'setup',
  ...
  },
  {
    ...
    steps: [
      ...
      step({
        ...
        body: 'Pick a model, choose 16:9 or 9:16, and set how many images to generate.',
      ...
      step({
        ...
        eyebrow: 'Thumbnail Generator',
        title: 'Results',
        body: 'Results appear in the pane above as they finish.',
