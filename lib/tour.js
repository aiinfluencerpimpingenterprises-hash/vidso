...
export const TOURS = [
  {
    ...
    steps: [
      ...
      step({
        ...
        body: 'Pick a narrator. The voiceover uses that voice when the video is generated.',
  ...
  },
  {
    ...
    steps: [
      step({
        ...
        eyebrow: 'My Files',
        title: 'Your library',
        body: 'Every video and thumbnail you generate lands here. Open one to play it, or download it anytime.',
        target: '#files-card',
        route: 'files',
      }),
      step({
  ...
  },
  {
    ...
    steps: [
      step({
        ...
        body: 'See Creative tools under the heading, then usage and shortcuts back into Long Form Generator.',
        target: '#dash-creative-tools',
        route: 'dashboard',
      }),
      step({
        id: 'quota',
