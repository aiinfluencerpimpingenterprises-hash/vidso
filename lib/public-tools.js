...
export const PRIVATE_TOOL_PATHS = ['/files']
...
export function isPublicToolPath(path) {
  ...
  if (PUBLIC_TOOL_PATHS.includes(p)) return true
  return p.startsWith('/home/inspirations/')
}
...
export const EXCLUDED_TOOLS = [
  { name: 'Dashboard', reason: 'In-app home. Public preview is allowed; it is not a marketing menu item.' },
