...
export const TOOL_MENU_ITEMS = {
  ...
  mcp: {
    name: 'Vidso MCP',
    href: '/mcp',
    description: 'Run your YouTube workflow from Claude',
  },
}

export const TOOL_MENU_COLUMNS = [
  { id: 'long-form', label: 'Long-form', items: ['videogen', 'editor', 'commentary', 'downloader'] },
  { id: 'shorts', label: 'Shorts & clips', items: ['clipper', 'ranking', 'reframe'] },
  { id: 'audio', label: 'Audio & captions', items: ['voiceover', 'captions'] },
  { id: 'image', label: 'Image', items: ['imagegen'] },
...
export const TOOL_SEO = {
  ...
  '/brand-kit': {
    title: 'Brand kit · Vidso',
    description: 'Save logos, colors, fonts, and intro clips for later.',
    index: true,
  },
  '/templates': {
    title: 'Templates · Vidso',
    description: 'Start from a Vidso layout.',
    index: true,
  },
  '/tutorials': {
    title: 'Tutorials · Vidso',
    description: 'Walkthroughs of Vidso tools.',
    index: true,
  },
  '/dashboard': {
    title: 'Home · Vidso',
