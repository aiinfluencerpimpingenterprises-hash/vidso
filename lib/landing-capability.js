...
const FORMAT_LIVE_SRC = {
  'long-form': R2 + '/landingpageformatslongform.mp4',
  shorts: R2 + '/landingpageformatsshort.mp4',
  ads: R2 + '/landingpageformatsad.mp4',
  ugc: R2 + '/landingpageformatsugc.mp4',
  explainers: R2 + '/facelessstudio3.mp4',
  'product-videos': R2 + '/landingpageformatsproduct.mp4',
  'talking-head': R2 + '/landingpageformatstalkinghead.mp4',
}

export function formatCardSrc(slug) {
  return FORMAT_LIVE_SRC[slug] || LANDING_R2 + '/format-card-' + slug + '.mp4'
}
...
export const PLACEHOLDER_FILES = {
  formats: FORMAT_CARDS.map((c) => c.src.split('/').pop()),
