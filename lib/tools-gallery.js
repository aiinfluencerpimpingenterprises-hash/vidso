...
export const TOOL_GALLERY = [
  { id: 'videogen', name: 'Long Form Generator', description: 'Script, voice, B-roll, and captions', href: '/video-generation', group: 'generate', topics: ['video', 'scripts'], image: R2 + '01_Long_Form_Generator.png', icon: ICO.videogen },
  { id: 'imagegen', name: 'Thumbnail Generator', description: 'Prompt to a YouTube thumbnail', href: '/image-generation', group: 'generate', topics: ['images'], image: R2 + '02_Thumbnail_Generator.png', icon: ICO.imagegen },
  ...
  { id: 'clipper', name: 'Clipping', description: 'Viral moments from any link', href: '/clipping', group: 'generate', topics: ['shorts'], image: R2 + '03_Clipping.png', icon: ICO.clipper },
  { id: 'ranking', name: 'Ranking', description: 'Assemble ranked short videos', href: '/ranking', group: 'generate', topics: ['shorts'], image: R2 + '04_Ranking.png', icon: ICO.ranking },
  { id: 'captions', name: 'AI Captions', description: 'Auto-transcribe any video', href: '/captions', group: 'create', topics: ['shorts', 'utilities'], image: R2 + '11_AI_Captions.png', icon: ICO.captions },
  { id: 'voiceover', name: 'AI Voiceover', description: 'Studio-quality narration from a script', href: '/voiceover', group: 'create', topics: ['audio'], image: R2 + '05_AI_Voiceover.png', icon: ICO.voiceover },
  { id: 'reframe', name: 'AI Reframe', description: 'Auto-fit landscape footage to 9:16', href: '/reframe', group: 'create', topics: ['video', 'shorts'], image: R2 + '06_AI_Reframe.png', icon: ICO.reframe },
  { id: 'editor', name: 'Video Editor', description: 'Multi-track timeline', href: '/editor', group: 'edit', topics: ['video'], image: R2 + '07_Video_Editor.png', icon: ICO.editor },
  { id: 'downloader', name: 'Video Downloader', description: 'Download from any platform', href: '/downloader', group: 'edit', topics: ['utilities'], image: R2 + '08_Video_Downloader.png', icon: ICO.downloader },
  { id: 'commentary', name: 'Video Commentary', description: 'Voice and captions on clips', href: '/commentary', group: 'edit', topics: ['video', 'audio'], image: R2 + '09_Video_Commentary.png', icon: ICO.commentary },
  { id: 'files', name: 'My Files', description: 'Your generated videos and thumbnails', href: '/files', group: 'manage', topics: ['utilities'], image: R2 + '10_My_Files.png', icon: ICO.files },
]
...
export function liveTools() {
  return TOOL_GALLERY.filter((t) => t.id !== 'facelessstudio' && !panelArchived(t.id) && !panelHiddenFromChrome(t.id))
}
