...
export const TOOL_GALLERY = [
  ...
  { id: 'clipper', name: 'Clipping', description: 'Viral moments from any link', href: '/clipping', group: 'generate', topics: ['shorts'], image: '', icon: ICO.clipper },
  { id: 'ranking', name: 'Ranking', description: 'Assemble ranked short videos', href: '/ranking', group: 'generate', topics: ['shorts'], image: '', icon: ICO.ranking },
  ...
  { id: 'voiceover', name: 'AI Voiceover', description: 'Studio-quality narration from a script', href: '/voiceover', group: 'create', topics: ['audio'], image: '', icon: ICO.voiceover },
  { id: 'reframe', name: 'AI Reframe', description: 'Auto-fit landscape footage to 9:16', href: '/reframe', group: 'create', topics: ['video', 'shorts'], image: '', icon: ICO.reframe },
  ...
  { id: 'downloader', name: 'Video Downloader', description: 'Download from any platform', href: '/downloader', group: 'edit', topics: ['utilities'], image: '', icon: ICO.downloader },
