...
const ICO = {
  ...
  mcp: '<svg fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/></svg>',
}
...
export const TOOL_GALLERY = [
  ...
  { id: 'files', name: 'My Files', description: 'Your generated videos and thumbnails', href: '/files', group: 'manage', image: '', icon: ICO.files },
  { id: 'mcp', name: 'MCP', description: 'Connect Claude or Cursor to this Vidso account', href: '/connectors', group: 'manage', image: '', icon: ICO.mcp },
]
