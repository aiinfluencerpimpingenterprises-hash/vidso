...
export const TOOL_GALLERY = [
  ...
  { id: 'ytvideogen', name: 'YouTube Generator', description: 'Pro: real YouTube clips for each script section', href: '/youtube-generation', group: 'generate', image: '', icon: ICO.ytvideogen },
