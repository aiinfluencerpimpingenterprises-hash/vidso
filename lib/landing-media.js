...
/** Setup-card screenshots. Stay blank until the matching /landing file is uploaded. */
export const MCP_SETUP_SHOTS = [
  { file: 'mcp-chatgpt-plugin-01', ext: 'jpg', tab: 'chatgpt' },
  { file: 'mcp-chatgpt-auth-01', ext: 'jpg', tab: 'chatgpt' },
  { file: 'mcp-chatgpt-chat-01', ext: 'jpg', tab: 'chatgpt' },
  { file: 'mcp-kimi-plugin-01', ext: 'jpg', tab: 'kimi' },
  { file: 'mcp-kimi-auth-01', ext: 'jpg', tab: 'kimi' },
  { file: 'mcp-kimi-chat-01', ext: 'jpg', tab: 'kimi' },
]
