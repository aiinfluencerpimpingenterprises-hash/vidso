...
/** Agent marks on /landing. Missing files stay blank. */
export const MCP_AGENT_LOGOS = [
  { file: 'agent-logo-claude.png', client: 'Claude', place: 'key-left, tab, strip' },
  { file: 'agent-logo-chatgpt.png', client: 'ChatGPT', place: 'key-inner-left, tab, strip' },
  { file: 'agent-logo-cursor.png', client: 'Cursor', place: 'key-inner-right, tab, strip' },
  { file: 'agent-logo-kimi.png', client: 'Kimi', place: 'key-right, tab, strip' },
  { file: 'agent-logo-other.png', client: 'Other MCP agents', place: 'tab, strip' },
]
