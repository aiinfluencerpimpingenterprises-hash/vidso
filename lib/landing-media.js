...
/** Agent marks on the MCP keycaps. Claude is the only confirmed connector. */
export const MCP_AGENT_LOGOS = [
  { file: 'claude-ai-icon.webp', client: 'Claude', src: R2 + '/claude-ai-icon.webp' },
  { file: 'openai-icon.svg', client: null, src: R2 + '/openai-icon.svg' },
  { file: 'cursor-ai-code-icon.svg', client: null, src: R2 + '/cursor-ai-code-icon.svg' },
  { file: 'kimi-ai-icon.svg', client: null, src: R2 + '/kimi-ai-icon.svg' },
]
