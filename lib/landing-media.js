...
/** MCP marketing placeholders on R2. Blank until the public file exists. */
export const MCP_AGENT_LOGOS = [
  { file: 'agent-logo-01.png', client: 'Claude' },
  { file: 'agent-logo-02.png', client: null },
  { file: 'agent-logo-03.png', client: null },
  { file: 'agent-logo-04.png', client: null },
]
