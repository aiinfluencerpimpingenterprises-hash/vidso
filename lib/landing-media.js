...
/** ~60% 16:9, ~40% 9:16. Ten cards around the hero headline. */
export const HERO_CARDS = [
  { type: 'long', src: '', poster: '' },
...
export const SHOWCASE_CARDS = [
  { category: 'EXPLAINER', prompt: 'Make a video on how airports make more money than airlines', src: '', poster: '' },
  { category: 'LISTICLE', prompt: 'Make a video on the top 10 scary stories that are actually true', src: '', poster: '' },
  { category: 'STORY', prompt: 'Make a video on the untold story behind a famous historic heist', src: '', poster: '' },
  { category: 'DOCUMENTARY', prompt: 'Make a video on abandoned places nobody is allowed to visit', src: '', poster: '' },
  { category: 'SHORT', prompt: 'Make a 60 second Short on the weirdest law still active in the US', src: '', poster: '' },
]
