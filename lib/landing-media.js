...
export const MCP_FEATURE_MEDIA = [
  { file: 'mcplongformchatplaceholder', ext: 'mp4', tab: 'longform' },
  { file: 'mcp-shorts-01', ext: 'mp4', tab: 'clips' },
  { file: 'mcp-shorts-02', ext: 'mp4', tab: 'clips' },
  { file: 'mcp-shorts-03', ext: 'mp4', tab: 'clips' },
  { file: 'mcpthumbnailplaceholder1', ext: 'png', tab: 'thumbs' },
  { file: 'mcpthumbnailplaceholder2', ext: 'png', tab: 'thumbs' },
  { file: 'mcpthumbnailplaceholder3', ext: 'png', tab: 'thumbs' },
  { file: 'mcpthumbnailplaceholder4', ext: 'png', tab: 'thumbs' },
  { file: 'mcp-voice-01', ext: 'mp4', tab: 'audio' },
  { file: '01-airport-secrets-video-preview', ext: 'png', tab: 'files' },
  { file: '02-airport-secrets-thumbnail-a', ext: 'png', tab: 'files' },
  { file: '03-airport-short-clip-preview', ext: 'png', tab: 'files' },
  { file: '04-voice-board-audio-cover', ext: 'png', tab: 'files' },
  { file: '05-free-upgrade-thumbnail-b', ext: 'png', tab: 'files' },
  { file: '06-reframe-9x16-video-preview', ext: 'png', tab: 'files' },
]

export const MCP_CHAT_MEDIA = [
  { file: 'mcplongformchatplaceholder', ext: 'mp4', item: 'longform' },
  { file: '01-thumbnail-generation-airport-secrets', ext: 'png', item: 'thumbs' },
  { file: 'Secrets Airlines Don’t Want You To Know!', ext: 'mp4', item: 'clips' },
  { file: '02-narrator-voiceover-output', ext: 'png', item: 'voice' },
  { file: '03-recent-files-render-status', ext: 'png', item: 'files' },
  { file: '04-plan-quota-plus-yearly', ext: 'png', item: 'account' },
]
...
export const HERO_CARDS = [
  { file: 'landingpagelongform', type: 'long', aspect: '16:9', label: 'Long-form', src: R2 + '/landingpagelongform.mp4', poster: '' },
  { file: 'landingpageshort', type: 'short', aspect: '9:16', label: 'Short', src: R2 + '/landingpageshort.mp4', poster: '' },
  { file: 'videocarousel4', type: 'short', aspect: '9:16', label: 'Ad', src: R2 + '/videocarousel4.mp4', poster: '' },
  { file: 'landingpageugc', type: 'short', aspect: '9:16', label: 'UGC', src: R2 + '/landingpageugc.mp4', poster: '' },
  { file: 'facelessstudio1', type: 'long', aspect: '16:9', label: 'Explainer', src: R2 + '/facelessstudio1.mp4', poster: '' },
  { file: 'landingpageproduct', type: 'long', aspect: '16:9', label: 'Product', src: R2 + '/landingpageproduct.mp4', poster: '' },
  { file: 'thumbnail', type: 'long', aspect: '16:9', label: 'Thumbnail', src: STILL.thumb, poster: STILL.thumb },
  { file: 'facelessstudio', type: 'long', aspect: '16:9', label: 'Voiceover', src: R2 + '/facelessstudio.mp4', poster: '' },
]
