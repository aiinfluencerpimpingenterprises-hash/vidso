...
/** Cards with media only. Page load uses `poster` stills, never the MP4. */
export const HERO_CARDS = [
  { type: 'long', src: CAROUSEL(1), poster: STILL.thumb },
  { type: 'short', src: HERO_VIDEO_SRC, poster: STILL.hero, start: 3 },
  { type: 'long', src: CAROUSEL(2), poster: STILL.thumb1 },
  { type: 'long', src: CAROUSEL(3), poster: STILL.thumb2 },
  { type: 'short', src: HERO_VIDEO_SRC, poster: STILL.hero, start: 9 },
  { type: 'long', src: CAROUSEL(4), poster: STILL.thumb3 },
  { type: 'short', src: HERO_VIDEO_SRC, poster: STILL.script, start: 15 },
  { type: 'long', src: CAROUSEL(5), poster: STILL.media },
  { type: 'long', src: CAROUSEL(6), poster: STILL.export },
  { type: 'short', src: STILL.claude, poster: STILL.claude },
]
...
export const SHOWCASE_CARDS = [
  ...
  { category: 'SHORT', prompt: 'Make a 60 second Short on a tiny habit that changes your day', src: CAROUSEL(8), poster: '', aspect: 'short' },
]
