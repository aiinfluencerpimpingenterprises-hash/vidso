...
import { bindCatalogClipLoop, catalogClipLoopSeconds, catalogHasClip, featuredMediaId, featuredModels, modelCardClipSrc, modelCardSrc, modelSlug } from './vidso-models.js?v=s15'
import {
  ASK_BEHAVIORS,
  ATTACH_GROUPS,
  AVATAR_MENU,
    ...
    <div class="studio-home">
      ...
      <div id="studio-home-rails">
        <section class="studio-rail" id="rail-start">
          ${railHead('Start creating')}
          <div class="studio-qs-grid" id="studio-start-grid">${startCards()}</div>
        </section>
