...
import { bindCatalogClipLoop, catalogClipLoopSeconds, catalogHasClip, featuredMediaId, featuredModels, modelById, modelCardClipSrc, modelCardSrc, modelSlug } from './vidso-models.js?v=s16'
import {
  ASK_BEHAVIORS,
  ATTACH_GROUPS,
  AVATAR_MENU,
