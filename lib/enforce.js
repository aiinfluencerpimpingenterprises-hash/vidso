...
/** Temporary testing: unpaid accounts get Studio access. Set false before charging again. */
export const PAYWALL_BYPASS = true
...
export function resolveAccess(user, env) {
  ...
  const resolved = resolveUserPlan(user, env)
