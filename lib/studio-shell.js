...
import { CLAUDE_ICON_URL, YOUTUBE_LOGO_URL } from '/lib/brand-assets.js'
...
export function connectorsMenuHtml() {
  return `<div class="fs-menu fs-conn-menu" id="fs-conn-menu" role="menu">
    ...
    <a role="menuitem" href="/video-generation?youtube=connect" data-conn="youtube">
...
export function connectorsBoardHtml() {
  return `<div class="fs-board">
    ...
    <div class="fs-conn-grid">
      ...
      <a class="fs-conn-card" href="/video-generation?youtube=connect">
