  ...
  return `<form class="fs-composer fs-composer-sc" id="fs-composer" autocomplete="off">
    ...
    <div class="fs-composer-bar">
      <div class="fs-composer-left">
        ...
        ${falBar ? `<label class="fs-bar-chip">
          ${icon('tv')}
          <select id="fs-video-model" aria-label="Video model">${videoModelInner}</select>
        </label>
        <label class="fs-bar-chip">
          ${icon('frame')}
          <select id="fs-aspect" aria-label="Aspect ratio">${aspectInner}</select>
        </label>
        <label class="fs-bar-chip" id="fs-clip-duration-chip">
          ${icon('clock')}
          <select id="fs-clip-duration" aria-label="Clip duration">${clipDurationInner}</select>
        </label>
